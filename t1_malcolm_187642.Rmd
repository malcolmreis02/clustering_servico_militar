...
\   Todo o processo de tratamento dos dados e de clusterização foi feito utilizando a linguagem R de programação e os códigos produzidos estão disponíveis [nesse projeto do GitHub](https://github.com/malcolmreis02)
